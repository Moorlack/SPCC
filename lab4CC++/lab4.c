...
MODULE_AUTHOR("Vasiutynskyi Oleksandr sych.worker@gmail.com");
MODULE_DESCRIPTION("Lab 4.2, find the largest element in a list");
MODULE_LICENSE("MIT");
#define LIST_LEN 16
...
static void find_largest(void) {
  ...
  print_msg("Largest value in the list: %d\n", largest);
}
